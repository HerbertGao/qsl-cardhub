<template>
  <div class="card-list">
    ...
    >
      ...
      <el-table-column prop="callsign" label="呼号" width="120" align="center"/>
      ...
      <el-table-column label="分发/退回时间" width="180" align="center">
        <template #default="{ row }">
          {{ getProcessTime(row) }}
        </template>
      </el-table-column>
      <el-table-column prop="created_at" label="录入时间" width="180" align="center">
        <template #default="{ row }">
